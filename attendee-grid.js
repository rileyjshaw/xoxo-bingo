...
// for xoxo participants to see
var attendees = JSON.parse(fs.readFileSync('attendees.json', 'utf8'));
// for everyone else
var followers = JSON.parse(fs.readFileSync('followers.json', 'utf8'));
var blacklist = [];
...
// let folks RSVP 'no' to the party
var rsvp_no = function(username) {
...
var attendeeListForUsername = function(username) {
    // we're only showing the xoxo card to xoxo attendees. other folks see
    // twitter accounts of popular xoxo followers
